...
$currentItems = array_slice($offres, $startIndex, $itemsPerPage);
?>
...
<body>
    ...
    <main class="admin-page">
        ...
        <tbody>
            <?php foreach($currentItems as $index => $offre): ?>
            <tr >
                <td><a href="details-offres.php?id=<?= $index ?>">
                    <?= htmlspecialchars($offre['offre']) ?>
                </a></td>
                <td><a href="details-offres.php?id=<?= $index ?>">
